...
const FAQs = () => {
  ...
  return (
    <div>
      <div class="my-12"></div>
      <section class="bg-white w-5/5 px-10 pb-8 pt-10 rounded-lg flex justify-between flex-col">
        ...
        <h1 className="font-extrabold text-3xl py-8 text-center">
        ...
        <div class="w-3/4 m-auto">
          <details class="border border-slate-200 rounded pt-2 pb-3 px-3 relative open:shadow-lg mb-1 bg-none open:bg-white duration-300">
            <summary class="list-none font-bold relative text-sm cursor-pointer pr-7">
            ...
            <p class="text-sm  pt-3">
              SEO boosts website visibility on Google, driving organic traffic
          ...
          <details class="border border-slate-200 rounded pt-2 pb-3 px-3 relative open:shadow-lg mb-1 bg-none open:bg-white duration-300">
            ...
            <p class="text-sm pt-3">
              Results vary, but expect improvements within a few months with
          ...
          <details class="border border-slate-200 rounded pt-2 pb-3 px-3 relative open:shadow-lg mb-1 bg-none open:bg-white duration-300">
            <summary class="list-none font-bold relative text-sm cursor-pointer pr-7">
              What makes your SEO services unique?
              <div class="absolute top-0 right-0 bg-slate-200 rounded-full px-1 py-0.5 cursor-pointer visible open:invisible">
                <svg
                  class="h-5 w-4 text-pink-700"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="text-sm pt-3">
              We blend expertise, data-driven strategies, and tailored
              approaches.
              <br />
              <br />
            </p>
          ...
          <details class="border border-slate-200 rounded pt-2 pb-3 px-3 relative open:shadow-lg mb-1 bg-none open:bg-white duration-300">
            ...
            <p class="text-sm pt-3">
              No, we offer flexible service options to suit your needs.
              <br />
              <br />
            </p>
          </details>
          <details class="border border-slate-200 rounded pt-2 pb-3 px-3 relative open:shadow-lg mb-1 bg-none open:bg-white duration-300">
            ...
            <p class="text-sm pt-3">
              Success is tracked through traffic, rankings, clicks, conversions,
              and ROI.
              <br />
              <br />
            </p>
